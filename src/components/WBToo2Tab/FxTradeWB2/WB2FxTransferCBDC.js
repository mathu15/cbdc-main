...
import WB2FxSelecAsset from "./WB2FxTransfer/WB2FxSelecAsset";
import WB2FxEnterAmount from "./WB2FxTransfer/WB2FxEnterAmount";
import WB2FxSelectExRate from "./WB2FxTransfer/WB2FxSelectExRate";
import WB2FxConfirmTransfer from "./WB2FxTransfer/WB2FxConfirmTransfer";
const WB2FxTransferCBDC = () => {
  ...
  const pageDisplay = () => {
    if (activeIndex === 0) {
      return <WB2FxSelecAsset data={data} setData={setData} />;
    } else if (activeIndex === 1) {
      return <WB2FxEnterAmount data={data} setData={setData} />;
    } else if (activeIndex === 2) {
      return <WB2FxSelectExRate data={data} setData={setData} />;
    } else if (activeIndex === 3) {
      return <WB2FxConfirmTransfer data={data} setData={setData} />;
...
export default WB2FxTransferCBDC;
