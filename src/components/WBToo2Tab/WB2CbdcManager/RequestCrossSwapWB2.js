...
import RevReqWB2Cross from "./RequestCrossSwapWB2/RevReqWB2Cross";

const RequestCrossSwapWB2 = () => {
  ...
  const pageDisplay = () => {
    if (activeIndex === 0) {
      return <SelectParWB2Cross data={data} setData={setData} />;
    } else if (activeIndex === 1) {
      return <SelectAssWB2Cross data={data} setData={setData} />;
    } else if (activeIndex === 2) {
      return <AssetAmtWB2Cross data={data} setData={setData} />;
    } else if (activeIndex === 3) {
      return <RevReqWB2Cross data={data} setData={setData} />;
...
export default RequestCrossSwapWB2;
