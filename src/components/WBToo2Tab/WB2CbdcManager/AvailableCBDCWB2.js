  ...
  return (
    <div className=" col-12 flex flex-column align-items-center justify-content-center  ">
      ...
      {data.map((cdata) => (
        ...
        >
          <div className="flex">
            <p className="w-2 text-xl text-left text-center font-bold text-blue-200 mr-3">
              CBDC Name:
            </p>
              ...
              <Accordion>
                <AccordionTab header={header}>
                  <div className="flex-column align-items-center border-bottom-1 surface-border surface-overlay w-full mt-5">
                    <p className=" text-left  text-xl font-bold text-blue-200 mr-3">
...
export default AvailableCBDCWB2;
