...
import BondsOverviewWB3 from "./RequestCBDCWB3/BondsOverviewWB3";
import SelectAssetRequestWB3 from "./RequestCBDCWB3/SelecAssetRequestWB3";
import EnterAmountWB3 from "./RequestCBDCWB3/EnterAmountWB3";
import RequestReviewWB3 from "./RequestCBDCWB3/RequestReviewWB3";

const RequestCBDCWB3 = () => {
  ...
  const pageDisplay = () => {
    if (activeIndex === 0) {
      return <BondsOverviewWB3 data={data} setData={setData} />;
    } else if (activeIndex === 1) {
      return <SelectAssetRequestWB3 data={data} setData={setData} />;
    } else if (activeIndex === 2) {
      return <EnterAmountWB3 data={data} setData={setData} />;
    } else if (activeIndex === 3) {
      return <RequestReviewWB3 data={data} setData={setData} />;
